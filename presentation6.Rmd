...
$$ 
\text{GDP} = T \times \text{(Physical capital)}^{1/3} \times \text{(Human capital)}^{2/3}
$$

$$ 
\text{GDP per worker} = T \times H  \times \text{(Physical capital per worker)}^{1/3} 
$$
- where $T$ is an estimate of the level of technology, and $H$: human capital is years of education
...
knitr::include_graphics("week6graphs/longrunmena.png") 
```
...
- [MENA Economic Outlook](https://ihsmarkit.com/research-analysis/mena-economic-outlook-2022-global-headwinds.html)

- [Productivity for prosperity](https://blogs.worldbank.org/psd/productivity-prosperity-long-run-it-almost-everything)

- [Long-run growth after COVID-19](https://www.brookings.edu/research/how-to-boost-long-run-growth-after-covid-19/)

- [Economic Growth: Is it everyone's benefits?](https://equitablegrowth.org/economic-growth-in-the-united-states-a-tale-of-two-countries/) 
