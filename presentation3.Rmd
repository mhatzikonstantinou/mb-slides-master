...
Except for the base year, real GDP (output at prices of a base year) is not the same as nominal GDP (output at current prices).
 ...
 - __GDP per capita:__ average GDP per person
...
- For example, in 1960, real GDP per person was $\$ 15,850$ and in 2012 , it was $\$ 42,800$.
...
GDP deflator $(2009)=100 \times \frac{58,300}{52,000}=112.1$
