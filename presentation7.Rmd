...
- Basically, TFP is a 'catch-all' for anything that effects output other than capital input $\mathrm{K}$ and education-adjusted labor $\mathrm{L}$.
...
- Economic growth tends to have the adverse impact on the environment:
